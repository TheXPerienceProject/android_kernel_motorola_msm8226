...
#elif CONFIG_ARCH_MSM8226 //FOR FALCON
#define DEF_POWER_SAVE_FREQUENCY		(300000)
#define DEF_TWO_PHASE_FREQUENCY			(1593600)
#define DBS_INPUT_EVENT_MIN_FREQ		(1593600)
#define DEF_FREQUENCY_OPTIMAL			(1593600)
#define DEF_FREQ_DOWN_STEP			(550000)
#define DEF_FREQ_DOWN_STEP_BARRIER		(1593600)
#else
